    ...
    <main className="min-h-screen bg-[radial-gradient(ellipse_at_top_right,rgba(79,179,179,0.1),transparent_50%),#f8fafc] px-4 pb-12 pt-32 sm:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 space-y-2 text-center">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#4FB3B3]">Proposal Pembangunan</p>
          <h1 className="font-heading text-4xl font-black tracking-tight text-[#1A1F2B]">Ajukan Proposal</h1>
        </div>
