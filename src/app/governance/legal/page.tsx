...
export default function LegalAnalysisPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                throw new Error(
                    json.error || "Gagal memuat daftar legal analysis.",
                );
            }
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center gap-2 rounded-2xl bg-[#4FB3B3] px-4 py-2.5 text-sm font-bold text-white shadow-lg transition hover:bg-[#3f9b9b]"
                        >
