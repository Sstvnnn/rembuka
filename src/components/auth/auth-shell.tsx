...
export function AuthShell({ children }: AuthShellProps) {
  return (
    ...
    <div className="min-h-screen bg-[#F6F5F2] text-[#1A1F2B] font-sans flex flex-col md:flex-row selection:bg-[#11538C]/20">
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }}

        className="hidden md:flex md:w-[45%] lg:w-1/2 bg-[#11538C] p-10 lg:p-20 flex-col justify-between text-white relative md:h-screen md:sticky md:top-0"
      >
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 md:p-16 lg:p-24 relative min-h-screen">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
